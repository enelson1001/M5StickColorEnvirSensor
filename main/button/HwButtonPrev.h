/****************************************************************************************
 * GuiButtonPrev.h - A class that creates a PREV Hardware button
 *
...
namespace redstone
{
    class HwButtonPrev : public HwButton
    {
        public:
            /// Constructor
            /// \param pin The GPIO pin used for the PREV button
            ...
            HwButtonPrev(gpio_num_t pin, bool pullup, bool pulldn);
        ...
        private:
            HwBtnPrevPressed hw_btn_prev_pressed;
            HwBtnPrevReleased hw_btn_prev_released;
    };
}
