...
namespace redstone
{
    ...
    void CPBmp280::create(int width, int height)
    {
        ...
        content_container_style.body.main_color = lv_color_hex3(0xFF0);  // yellow
        content_container_style.body.grad_color = lv_color_hex3(0xFF0);  // yellow
        ...
        lv_obj_set_style(label_press_hpa, &text_label_style);
        ...
        lv_obj_set_style(label_press_inhg, &text_label_style);
        ...
        lv_obj_set_style(temperature_value_label, &text_label_style);
        ...
        lv_obj_set_style(hpa_press_value_label, &text_label_style);
        ...
        lv_obj_set_style(inhg_press_value_label, &text_label_style);
